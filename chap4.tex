...
\begin{table}[!htbp]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{p{0.2\textwidth} p{0.4\textwidth} p{0.4\textwidth}}
            ...
            \addlinespace
            \textbf{Final Size}     & 400 course pairs                                 &   9192 course pairs               \\
            \addlinespace
...
\midrule
BGE & 64 & 0.967681 & 0.015185 & 0.900304 & 0.957357 & 0.973832 & 0.978318 & 0.984612 \\
BGE-ft & 63 & 0.978746 & 0.004320 & 0.968707 & 0.976240 & 0.979922 & 0.981683 & 0.987702 \\
GIST & 63 & 0.971851 & 0.012516 & 0.913939 & 0.965367 & 0.977210 & 0.981077 & 0.984083 \\
NVE & 64 & 0.970530 & 0.013705 & 0.937957 & 0.960745 & 0.975147 & 0.982084 & 0.985258 \\
SFR & 64 & 0.972254 & 0.014617 & 0.922104 & 0.963553 & 0.978764 & 0.982926 & 0.986549 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\begin{tabular}{cccc}
\toprule
\textbf{Statistic (W)} & \textbf{df1} & \textbf{df2} & \textbf{p-value} \\
\midrule
7.0286 & 4 & 313 & \(<0.001\) \\
\bottomrule
\end{tabular}
...
\begin{table}[!htbp]
    \captionsetup{skip=5pt}
\centering
\caption{Games-Howell Post-Hoc Test for Classifiers\(^\dagger\)}
\label{tbl:games_howell_embedding_model}
        \begin{tabular}{llrrrrr}
            \toprule
             &  & \textbf{Mean} &  & \textbf{95\% CI} & \textbf{95\% CI} & \\
            \textbf{Group 1} & \textbf{Group 2} & \textbf{Diff.} & \textbf{p-val}\(^*\) & \textbf{Lower} & \textbf{Upper} & \textbf{Reject}\\
\midrule
...
\bottomrule
\multicolumn{7}{l}{\scriptsize\(^\dagger\) Across all embedding models and all tests}\\
\multicolumn{7}{l}{\scriptsize\(^*\) Adjusted \(p\)-value using Tukey's method}
\end{tabular}
\end{table}
...
\midrule
None & 20 & 0.962981 & 0.024292 & 0.900304 & 0.961691 & 0.972235 & 0.976458 & 0.983663 \\
PaCMAP & 98 & 0.981104 & 0.001835 & 0.977172 & 0.979452 & 0.981442 & 0.982431 & 0.984393 \\
PCA & 100 & 0.971991 & 0.012743 & 0.937957 & 0.962466 & 0.977626 & 0.982058 & 0.987702 \\
UMAP & 100 & 0.965505 & 0.011596 & 0.938061 & 0.956572 & 0.968961 & 0.974924 & 0.982183 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\midrule
5 & 60 & 0.966575 & 0.014254 & 0.937957 & 0.955814 & 0.969970 & 0.980417 & 0.983850 \\
7 & 59 & 0.970692 & 0.009840 & 0.950073 & 0.962735 & 0.972467 & 0.980017 & 0.983124 \\
70\% & 60 & 0.975803 & 0.009528 & 0.944029 & 0.973550 & 0.979290 & 0.982021 & 0.985604 \\
80\% & 60 & 0.976336 & 0.009952 & 0.938061 & 0.975156 & 0.979441 & 0.982494 & 0.986549 \\
90\% & 59 & 0.974646 & 0.012442 & 0.939868 & 0.974690 & 0.979041 & 0.982269 & 0.987702 \\
Original & 20 & 0.962981 & 0.024292 & 0.900304 & 0.961691 & 0.972235 & 0.976458 & 0.983663 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\begin{table}[!htbp]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{lcccccccc}
            ...
            \midrule
            KNN & 80 & 0.971147 & 0.015208 & 0.900304 & 0.971809 & 0.977110 & 0.979110 & 0.982437 \\
            RF & 80 & 0.970490 & 0.014473 & 0.938061 & 0.957396 & 0.978490 & 0.982073 & 0.984572 \\
            SVM & 78 & 0.976210 & 0.009112 & 0.939885 & 0.970793 & 0.979567 & 0.982795 & 0.987702 \\
            XGB & 80 & 0.971026 & 0.012316 & 0.942860 & 0.959382 & 0.977547 & 0.981376 & 0.984898 \\
            \bottomrule
        \end{tabular}
    }
\end{table}
...
\caption[Venn Diagram of Misclassified Pairs]{Venn diagram illustrating the overlap of misclassified pairs on the test dataset between all five embedding models and the four finalist classifiers. The central intersection shows 211 pairs were misclassified by all models, indicating shared data challenges.}
...
\caption[Model Overlap for Misclassified Pairs]{Number of common misclassified pairs on the test dataset between all five embedding models and the four finalist classifiers. The high counts of common errors across different models point to similar challenges inherent in the data.}
...
\begin{itemize}
    \item \textbf{Topical Overlap without True Equivalence:} This error arises when courses cover the same broad subject but differ in scope such as academic level or their position in a curricular sequence. The model correctly identifies high semantic similarity but fails to capture the nuanced distinctions that make the courses non-equivalent. An example is the pair of PHYS-4D and PHYS-4A from Foothill College, which are sequential calculus-based physics courses covering modern and classical mechanics, respectively. Their shared title and subject matter create high semantic overlap, but they are not equivalent for transfer purposes (Appendix~\ref{app:topicoverlap}).  It is worth noting that the fine-tuned model may not sufficiently learn from course sequence metadata (e.g., prerequisites) present in the texts to distinguish between courses in a series.  However, such metadata is likely more suited to be utilized more explicitly as a set of features rather than relying on an embedding model to implicitly learn these relationships purely from the text.  In any case, such an intra-institutional comparison is an unlikely scenario for a framework designed primarily for inter-institutional articulation.
