...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.5\textwidth}
            % --- SUGGESTED GRAPHIC ---
            % A simple flowchart is ideal here to show the process.
            % It would visually represent this specific step:
            %
            % [Composite Distance Vector (\Delta_c)] -> [ML Classifier] -> [Prediction: Equivalent / Not Equivalent]
            %
            % This clearly illustrates the input, process, and output
            % of this methodological step.
            \centering
...
%             \centering
%             \includegraphics[width=\textwidth]{Binary Classification Eval fine-tuning.png} % Placeholder for Figure 4.2
