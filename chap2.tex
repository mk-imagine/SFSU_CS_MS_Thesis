...
Every figure in the document should be referenced somewhere within the text.
...
%% see the AMS math user guide document for more information: https://www.ams.org/arc/tex/amsmath/amsldoc.pdf
